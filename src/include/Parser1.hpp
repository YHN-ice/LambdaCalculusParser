  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_exprlist = 12,                         // exprlist
        S_assignment = 13,                       // assignment
        S_expression = 14,                       // expression
        S_expression_r = 15,                     // expression_r
        S_expression_l = 16,                     // expression_l
        S_function = 17,                         // function
        S_application = 18                       // application
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_application: // application
        value.move< L > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, L&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const L& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_LAMBDA ()
      {
        return symbol_type (token::LAMBDA);
      }
#else
      static
      symbol_type
...
#line 1254 "Parser1.hpp"


// "%code provides" blocks.
#line 24 "grammar/grammar1.y"

    #define YY_DECL \
        int yylex(lambda::Parser::semantic_type *yylval, yyscan_t yyscanner)
    YY_DECL;

#line 1264 "Parser1.hpp"
